...
const SignUp = () => {
    ...
    return (
        <div className="hero min-h-screen">
            <div className="card bg-mauve-500 w-full max-w-sm shrink-0 shadow-2xl">
                <form onSubmit={handleRegister} className="card-body">
                    <fieldset className="fieldset">
                        ...
                        {show ?
                            <FaEye onClick={() => setShow(false)} className='absolute right-13 top-52 cursor-pointer'></FaEye> :
                            <FaEyeSlash onClick={() => setShow(true)} className='absolute right-13 top-52 cursor-pointer'></FaEyeSlash>
                        }
                ...
                <button type="button" onClick={handleGoogleSign} className="btn bg-white text-black border-[#e5e5e5] w-3/4 mx-auto mb-3">
