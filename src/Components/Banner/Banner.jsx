...
const Banner = () => {
    return (
        ...
        bg-linear-to-r from-gray-400 to-indigo-300 text-white'>
            ...
            <img src={bannerPic} className='w-85 md:w-95 h-89 my-5 rounded-3xl ml-0 md:ml-10 shadow-2xl bg-gray-950' alt="" />
        </div>
    );
};
